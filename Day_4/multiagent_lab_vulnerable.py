# ============================================================
# DAY 4 LAB — VULNERABLE REPORT AGENT (BEFORE GUARDRAILS)
# ============================================================
...
class AgentState(TypedDict):
    ...
    # Untrusted external instruction used in the vulnerable test.
...
"""
    ...
    # VULNERABLE DEMO:
    # The untrusted instruction is passed directly as a later user message.
    # There is no validation or guardrail before it reaches the Report Agent.
    response = llm.invoke([
        HumanMessage(content=prompt),
